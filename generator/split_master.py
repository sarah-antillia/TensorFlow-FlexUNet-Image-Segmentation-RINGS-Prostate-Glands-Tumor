...
if __name__ == "__main__":
  try:
    images_dir = "./Prostate-Glands-and-Tumor-master/images/"
    masks_dir  = "./Prostate-Glands-and-Tumor-master/masks/"
    output_dir = "./RINGS-Prostate-Glands-Tumor-ImageMask-Dataset-V2/"
